...
type
  ...
  { TRqliteMonitorFactory }

  TRqliteMonitorFactory = class
    class function CreateInstance(const AHttpClient: IHttpClient): IRqliteMonitor;
  end;
...
class function TRqliteMonitorFactory.CreateInstance(
  const AHttpClient: IHttpClient): IRqliteMonitor;
begin
  Result := TRqliteMonitor.Create(AHttpClient);
end;
